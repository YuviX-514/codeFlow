    ...
    <footer className="bg-gray-900 text-white pt-16 pb-8 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div className="md:col-span-1">
          <a href="/" className="text-2xl font-bold text-white">CodeFlow</a>
          <p className="mt-4 text-gray-400">Streamlining your development workflow</p>
      ...
      <div className="max-w-7xl mx-auto mt-12 pt-8 border-t border-gray-800 flex flex-col md:flex-row justify-between items-center">
        <p className="text-gray-400 text-sm">&copy; {new Date().getFullYear()} Code-Flow. All rights reserved.</p>
